...
export const MAQUINAS_MOCK: (Maquina & { categoria: string })[] = [
  { id: 'm1', nome: 'Hélice Contínua 01 (Caminhão)', status: 'DISPONIVEL', categoria: 'HELICE', tenantId: 'demo-tenant' },
  { id: 'm2', nome: 'Hélice Contínua 02 (Esteira)', status: 'EM_OBRA', categoria: 'HELICE', tenantId: 'demo-tenant' },
  { id: 'm3', nome: 'Perfuratriz Escavada 01', status: 'DISPONIVEL', categoria: 'ESCAVADA', tenantId: 'demo-tenant' },
  { id: 'm4', nome: 'Perfuratriz Escavada 02', status: 'MANUTENCAO', categoria: 'ESCAVADA', tenantId: 'demo-tenant' },
];

export const AGENDAMENTOS_MOCK: Agendamento[] = [
  { id: 'a1', maquinaId: 'm2', clienteNome: 'Obra Tenda', dataInicio: '2025-12-01', dataFim: '2025-12-15', tenantId: 'demo-tenant' }
];
